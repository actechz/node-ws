...
const UUID = process.env.UUID || 'cc541116-6e3a-4142-ab36-e06321c74ccc'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'cc541116-6e3a-4142-ab36-e06321c74ccc';            // 获取节点的订阅路径
